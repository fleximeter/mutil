...
def generate_chains_weak(p0: pitch.PitchClass, sc_list: list, max_2_similarity: float = 0.4, max_3_similarity: float = 1):
    """
    Generates all possible "weak" chains of pcsets that match the specified input criteria.
    The result is a list of posets of the form
    <pc_0 {...} pc_1 {...} pc_2 {...}>
