...
VALID_COMMANDS = {"about", "a", "exit", "x", "info", "n", "load", "l", "mod", "ordered search", "oh", "quit", "q", "search", "h", "subsets", "s", "subsets prime", "sp"}
...
def about():
    ...
    """
    print(("pcseg calculator copyright (c) 2024 by Jeffrey Martin. All rights reserved.\n"
