...
num_notes = 200
path = "data\\song4.mid"
z = algorithms.NoteEnvelope([(55, 65), (55, 72), (60, 72), (60, 77), (60, 72)], 
                            [0, int(num_notes*0.3), int(num_notes*0.5), int(num_notes*0.7), int(num_notes)])
notes = algorithms.wander_nth_int(57, num_notes, 
                        [1, 2, 4, 5, 7, 11], 
                        [(2, 2), (9, 6), (7, 3), (7, 3), (5, 2), (4, 1)],
                        z,
                        5,
                        4)
algorithms.stochastic_add_rests(notes, 15, 10)
