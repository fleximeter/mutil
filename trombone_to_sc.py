...
def build_score():
    ...
    pan1 = {
        ...
        # m73
        "0,0,152": Pan(start_note=(0, 0, 152), pan2=0, panx=0.3, panw=2.0),
        "0,0,153": Pan(start_note=(0, 0, 153), pan2=0, panx=0.3, panw=2.0),
        "0,5,85": Pan(start_note=(0, 5, 85), pan2=0, panx=0.7, panw=2.0),
        "0,5,86": Pan(start_note=(0, 5, 86), pan2=0, panx=0.7, panw=2.0),
        # m75
        "0,0,154": Pan(start_note=(0, 0, 154), pan2=0, panx=0.3, panw=2.0),
        "0,0,155": Pan(start_note=(0, 0, 155), pan2=0, panx=0.3, panw=2.0),
        "0,0,156": Pan(start_note=(0, 0, 156), pan2=0, panx=0.3, panw=2.0),
        "0,5,87": Pan(start_note=(0, 5, 87), pan2=0, panx=0.7, panw=2.0),
        # m76
        "0,0,157": Pan(start_note=(0, 0, 157), pan2=0, panx=0.3, panw=2.0),
        "0,0,158": Pan(start_note=(0, 0, 158), pan2=0, panx=0.3, panw=2.0),
        "0,0,159": Pan(start_note=(0, 0, 159), pan2=0, panx=0.3, panw=2.0),
        "0,0,160": Pan(start_note=(0, 0, 160), pan2=0, panx=0.3, panw=2.0),
        "0,0,161": Pan(start_note=(0, 0, 161), pan2=0, panx=0.3, panw=2.0),
        "0,1,5": Pan(start_note=(0, 1, 5), pan2=0, panx=0.45, panw=2.0),
        "0,1,6": Pan(start_note=(0, 1, 6), pan2=0, panx=0.45, panw=2.0),
        "0,1,7": Pan(start_note=(0, 1, 7), pan2=0, panx=0.45, panw=2.0),
        "0,5,88": Pan(start_note=(0, 5, 88), pan2=0, panx=0.55, panw=2.0),
        "0,7,2": Pan(start_note=(0, 7, 2), pan2=0, panx=0.7, panw=2.0),
        "0,7,3": Pan(start_note=(0, 7, 3), pan2=0, panx=0.7, panw=2.0),
        "0,7,4": Pan(start_note=(0, 7, 4), pan2=0, panx=0.7, panw=2.0),
        # m77
        "0,0,162": Pan(start_note=(0, 0, 162), pan2=0, panx=0.4, panw=2.0),
        "0,0,163": Pan(start_note=(0, 0, 163), pan2=0, panx=0.5, panw=2.0),
        "0,0,164": Pan(start_note=(0, 0, 164), pan2=0, panx=0.6, panw=2.0),
        "0,0,165": Pan(start_note=(0, 0, 165), pan2=0, panx=0.5, panw=2.0),
        "0,5,89": Pan(start_note=(0, 5, 89), pan2=0, panx=0.4, panw=2.0),
        "0,5,90": Pan(start_note=(0, 5, 90), pan2=0, panx=0.5, panw=2.0),
        "0,5,91": Pan(start_note=(0, 5, 91), pan2=0, panx=0.6, panw=2.0),
        "0,5,92": Pan(start_note=(0, 5, 92), pan2=0, panx=0.6, panw=2.0),
        "0,7,5": Pan(start_note=(0, 7, 5), pan2=0, panx=0.7, panw=2.0),
        # m79
        "0,0,166": Pan(start_note=(0, 0, 166), pan2=0, panx=0.3, panw=2.0),
        "0,0,167": Pan(start_note=(0, 0, 167), pan2=0, panx=0.3, panw=2.0),
        "0,0,168": Pan(start_note=(0, 0, 168), pan2=0, panx=0.3, panw=2.0),
        "0,0,169": Pan(start_note=(0, 0, 169), pan2=0, panx=0.3, panw=2.0),
        "0,5,93": Pan(start_note=(0, 5, 93), pan2=0, panx=0.7, panw=2.0),
        "0,5,94": Pan(start_note=(0, 5, 94), pan2=0, panx=0.7, panw=2.0),
        "0,5,95": Pan(start_note=(0, 5, 95), pan2=0, panx=0.7, panw=2.0),
        "0,5,96": Pan(start_note=(0, 5, 96), pan2=0, panx=0.7, panw=2.0),
        # m80
        "0,0,170": Pan(start_note=(0, 0, 170), pan2=0, panx=0.3, panw=2.0),
        "0,0,171": Pan(start_note=(0, 0, 171), pan2=0, panx=0.3, panw=2.0),
        "0,0,172": Pan(start_note=(0, 0, 172), pan2=0, panx=0.3, panw=2.0),
        "0,0,173": Pan(start_note=(0, 0, 173), pan2=0, panx=0.3, panw=2.0),
        "0,0,174": Pan(start_note=(0, 0, 174), pan2=0, panx=0.3, panw=2.0),
        "0,5,97": Pan(start_note=(0, 5, 97), pan2=0, panx=0.7, panw=2.0),
        "0,5,98": Pan(start_note=(0, 5, 98), pan2=0, panx=0.7, panw=2.0),
        # m81
        "0,0,175": Pan(start_note=(0, 0, 175), pan2=0, panx=0.3, panw=2.0),
        "0,0,176": Pan(start_note=(0, 0, 176), pan2=0, panx=0.3, panw=2.0),
        "0,0,177": Pan(start_note=(0, 0, 177), pan2=0, panx=0.3, panw=2.0),
        "0,0,178": Pan(start_note=(0, 0, 178), pan2=0, panx=0.3, panw=2.0),
        "0,0,179": Pan(start_note=(0, 0, 179), pan2=0, panx=0.3, panw=2.0),
        # m82
        "0,0,180": Pan(start_note=(0, 0, 180), pan2=0, panx=0.3, panw=2.0),
        "0,0,181": Pan(start_note=(0, 0, 181), pan2=0, panx=0.6, panw=2.0),
        "0,1,8": Pan(start_note=(0, 1, 8), pan2=0, panx=0.6, panw=2.0),
        # m83
        "0,0,182": Pan(start_note=(0, 0, 182), pan2=0, panx=0.3, panw=2.0),
        "0,0,183": Pan(start_note=(0, 0, 183), pan2=0, panx=0.7, panw=2.0),
        "0,0,184": Pan(start_note=(0, 0, 184), pan2=0, panx=0.3, panw=2.0),
        "0,0,185": Pan(start_note=(0, 0, 185), pan2=0, panx=0.4, panw=2.0),
        "0,0,186": Pan(start_note=(0, 0, 186), pan2=0, panx=0.6, panw=2.0),
        "0,0,187": Pan(start_note=(0, 0, 187), pan2=0, panx=0.7, panw=2.0),
        "0,0,188": Pan(start_note=(0, 0, 188), pan2=0, panx=0.3, panw=2.0),
        "0,1,9": Pan(start_note=(0, 1, 9), pan2=0, panx=0.6, panw=2.0),
        # m84
        "0,0,189": Pan(start_note=(0, 0, 189), pan2=0, panx=0.4, panw=2.0),
        "0,0,190": Pan(start_note=(0, 0, 190), pan2=0, panx=0.5, panw=2.0),
        "0,0,191": Pan(start_note=(0, 0, 191), pan2=0, panx=0.6, panw=2.0),
        "0,0,192": Pan(start_note=(0, 0, 192), pan2=0, panx=0.5, panw=2.0),
        "0,1,10": Pan(start_note=(0, 1, 10), pan2=0, panx=0.5, panw=2.0),
        "0,1,11": Pan(start_note=(0, 1, 11), pan2=0, panx=0.5, panw=2.0),
        # m85
        "0,0,193": Pan(start_note=(0, 0, 193), pan2=0, panx=0.5, panw=2.0),
        "0,0,194": Pan(start_note=(0, 0, 194), pan2=0, panx=0.6, panw=2.0),
        "0,0,195": Pan(start_note=(0, 0, 195), pan2=0, panx=0.7, panw=2.0),
        "0,0,196": Pan(start_note=(0, 0, 196), pan2=0, panx=0.5, panw=2.0),
        "0,1,12": Pan(start_note=(0, 1, 12), pan2=0, panx=0.5, panw=2.0),
        "0,1,13": Pan(start_note=(0, 1, 13), pan2=0, panx=0.5, panw=2.0),
        # m86
        "0,0,197": Pan(start_note=(0, 0, 197), pan2=0, panx=0.4, panw=2.0),
        "0,0,198": Pan(start_note=(0, 0, 198), pan2=0, panx=0.3, panw=2.0),
        "0,0,199": Pan(start_note=(0, 0, 199), pan2=0, panx=0.2, panw=2.0),
        "0,0,200": Pan(start_note=(0, 0, 200), pan2=0, panx=0.3, panw=2.0),
        "0,0,201": Pan(start_note=(0, 0, 201), pan2=0, panx=0.4, panw=2.0),
        "0,0,202": Pan(start_note=(0, 0, 202), pan2=0, panx=0.5, panw=2.0),
        "0,0,203": Pan(start_note=(0, 0, 203), pan2=0, panx=0.6, panw=2.0),
        "0,0,204": Pan(start_note=(0, 0, 204), pan2=0, panx=0.5, panw=2.0),
        "0,1,14": Pan(start_note=(0, 1, 14), pan2=0, panx=0.6, panw=2.0),
        "0,1,15": Pan(start_note=(0, 1, 15), pan2=0, panx=0.5, panw=2.0),
        # m87
        "0,0,205": Pan(start_note=(0, 0, 205), pan2=0, panx=0.4, panw=2.0),
        "0,0,206": Pan(start_note=(0, 0, 206), pan2=0, panx=0.5, panw=2.0),
        "0,0,207": Pan(start_note=(0, 0, 207), pan2=0, panx=0.5, panw=2.0),
        "0,1,16": Pan(start_note=(0, 1, 16), pan2=0, panx=0.5, panw=2.0),
        "0,5,99": Pan(start_note=(0, 5, 99), pan2=0, panx=2.5, panw=2.0),
        "0,6,2": Pan(start_note=(0, 6, 2), pan2=0, panx=2.5, panw=2.0),
        # m89
        "0,0,208": Pan(start_note=(0, 0, 208), pan2=0, panx=0.5, panw=2.0),
        "0,0,209": Pan(start_note=(0, 0, 209), pan2=0, panx=0.5, panw=2.0),
        "0,1,17": Pan(start_note=(0, 1, 17), pan2=0, panx=0.5, panw=2.0),
        "0,1,18": Pan(start_note=(0, 1, 18), pan2=0, panx=0.5, panw=2.0),
        "0,5,100": Pan(start_note=(0, 5, 100), pan2=0, panx=2.5, panw=2.0),
        "0,5,101": Pan(start_note=(0, 5, 101), pan2=0, panx=0.4, panw=2.0),
        "0,5,102": Pan(start_note=(0, 5, 102), pan2=0, panx=0.4, panw=2.0),
        "0,5,103": Pan(start_note=(0, 5, 103), pan2=0, panx=0.4, panw=2.0),
        "0,6,3": Pan(start_note=(0, 6, 3), pan2=0, panx=2.5, panw=2.0),
        "0,6,4": Pan(start_note=(0, 6, 4), pan2=0, panx=0.7, panw=2.0),
        "0,6,5": Pan(start_note=(0, 6, 5), pan2=0, panx=0.7, panw=2.0),
        # m90
        "0,0,210": Pan(start_note=(0, 0, 210), pan2=0, panx=0.2, panw=2.0),
        "0,0,211": Pan(start_note=(0, 0, 211), pan2=0, panx=0.2, panw=2.0),
        "0,0,212": Pan(start_note=(0, 0, 212), pan2=0, panx=0.2, panw=2.0),
        "0,1,19": Pan(start_note=(0, 1, 19), pan2=0, panx=0.5, panw=2.0),
        "0,1,20": Pan(start_note=(0, 1, 20), pan2=0, panx=0.5, panw=2.0),
        "0,1,21": Pan(start_note=(0, 1, 21), pan2=0, panx=0.5, panw=2.0),
        "0,5,104": Pan(start_note=(0, 5, 104), pan2=0, panx=0.4, panw=2.0),
        "0,5,105": Pan(start_note=(0, 5, 105), pan2=0, panx=0.4, panw=2.0),
        "0,6,6": Pan(start_note=(0, 6, 6), pan2=0, panx=0.7, panw=2.0),
        "0,6,7": Pan(start_note=(0, 6, 7), pan2=0, panx=0.7, panw=2.0),
        # m91
        "0,0,213": Pan(start_note=(0, 0, 213), pan2=0, panx=0.5, panw=2.0),
        "0,0,214": Pan(start_note=(0, 0, 214), pan2=0, panx=0.4, panw=2.0),
        "0,0,215": Pan(start_note=(0, 0, 215), pan2=0, panx=0.5, panw=2.0),
        "0,0,216": Pan(start_note=(0, 0, 216), pan2=0, panx=0.6, panw=2.0),
        "0,0,217": Pan(start_note=(0, 0, 217), pan2=0, panx=0.5, panw=2.0),
        # m92
        "0,5,106": Pan(start_note=(0, 5, 106), pan2=0, panx=0.4, panw=2.0),
        "0,5,107": Pan(start_note=(0, 5, 107), pan2=0, panx=0.4, panw=2.0),
        "0,5,108": Pan(start_note=(0, 5, 108), pan2=0, panx=0.45, panw=2.0),
        "0,5,109": Pan(start_note=(0, 5, 109), pan2=0, panx=0.45, panw=2.0),
        "0,5,110": Pan(start_note=(0, 5, 110), pan2=0, panx=0.55, panw=2.0),
        "0,5,111": Pan(start_note=(0, 5, 111), pan2=0, panx=0.55, panw=2.0),
        "0,6,8": Pan(start_note=(0, 6, 8), pan2=0, panx=0.6, panw=2.0),
        "0,6,9": Pan(start_note=(0, 6, 9), pan2=0, panx=0.65, panw=2.0),
        "0,6,10": Pan(start_note=(0, 6, 10), pan2=0, panx=0.7, panw=2.0),
        "0,6,11": Pan(start_note=(0, 6, 11), pan2=0, panx=0.7, panw=2.0),
        "0,6,12": Pan(start_note=(0, 6, 12), pan2=0, panx=0.7, panw=2.0),
        "0,6,13": Pan(start_note=(0, 6, 13), pan2=0, panx=0.7, panw=2.0),
        # m93
        "0,5,112": Pan(start_note=(0, 5, 112), pan2=0, panx=0.5, panw=2.0),
        "0,5,113": Pan(start_note=(0, 5, 113), pan2=0, panx=0.45, panw=2.0),
        "0,5,114": Pan(start_note=(0, 5, 114), pan2=0, panx=0.4, panw=2.0),
        "0,5,115": Pan(start_note=(0, 5, 115), pan2=0, panx=0.4, panw=2.0),
        "0,5,116": Pan(start_note=(0, 5, 116), pan2=0, panx=0.35, panw=2.0),
        "0,5,117": Pan(start_note=(0, 5, 117), pan2=0, panx=0.35, panw=2.0),
        "0,5,118": Pan(start_note=(0, 5, 118), pan2=0, panx=0.3, panw=2.0),
        "0,6,14": Pan(start_note=(0, 6, 14), pan2=0, panx=0.6, panw=2.0),
        "0,6,15": Pan(start_note=(0, 6, 15), pan2=0, panx=0.6, panw=2.0),
        "0,6,16": Pan(start_note=(0, 6, 16), pan2=0, panx=0.55, panw=2.0),
        "0,6,17": Pan(start_note=(0, 6, 17), pan2=0, panx=0.55, panw=2.0),
        "0,6,18": Pan(start_note=(0, 6, 18), pan2=0, panx=0.5, panw=2.0),
        # m94
        "0,0,218": Pan(start_note=(0, 0, 218), pan2=0, panx=0.55, panw=2.0),
        "0,0,219": Pan(start_note=(0, 0, 219), pan2=0, panx=0.5, panw=2.0),
        "0,0,220": Pan(start_note=(0, 0, 220), pan2=0, panx=0.45, panw=2.0),
        "0,0,221": Pan(start_note=(0, 0, 221), pan2=0, panx=0.4, panw=2.0),
        "0,0,222": Pan(start_note=(0, 0, 222), pan2=0, panx=0.45, panw=2.0),
        "0,0,223": Pan(start_note=(0, 0, 223), pan2=0, panx=0.5, panw=2.0),
        "0,0,224": Pan(start_note=(0, 0, 224), pan2=0, panx=0.55, panw=2.0),
        "0,0,225": Pan(start_note=(0, 0, 225), pan2=0, panx=0.5, panw=2.0),
        "0,0,226": Pan(start_note=(0, 0, 226), pan2=0, panx=0.45, panw=2.0),
        "0,0,227": Pan(start_note=(0, 0, 227), pan2=0, panx=0.5, panw=2.0),
        "0,0,228": Pan(start_note=(0, 0, 228), pan2=0, panx=0.5, panw=2.0),
        "0,5,119": Pan(start_note=(0, 5, 119), pan2=0, panx=0.7, panw=2.0),
        "0,5,120": Pan(start_note=(0, 5, 120), pan2=0, panx=0.65, panw=2.0),
        # m96
        "0,5,121": Pan(start_note=(0, 5, 121), pan2=0, panx=0.5, panw=2.0),
        "0,5,122": Pan(start_note=(0, 5, 122), pan2=0, panx=0.5, panw=2.0),
        "0,5,123": Pan(start_note=(0, 5, 123), pan2=0, panx=0.45, panw=2.0),
        "0,5,124": Pan(start_note=(0, 5, 124), pan2=0, panx=0.45, panw=2.0),
        "0,7,6": Pan(start_note=(0, 7, 6), pan2=0, panx=0.7, panw=2.0),
        "0,7,7": Pan(start_note=(0, 7, 7), pan2=0, panx=0.7, panw=2.0),
        "0,6,19": Pan(start_note=(0, 6, 19), pan2=0, panx=0.65, panw=2.0),
        "0,6,20": Pan(start_note=(0, 6, 20), pan2=0, panx=0.65, panw=2.0),
        # m97
        "0,5,125": Pan(start_note=(0, 5, 125), pan2=0, panx=0.4, panw=2.0),
        "0,5,126": Pan(start_note=(0, 5, 126), pan2=0, panx=0.4, panw=2.0),
        "0,5,127": Pan(start_note=(0, 5, 127), pan2=0, panx=0.4, panw=2.0),
        "0,5,128": Pan(start_note=(0, 5, 128), pan2=0, panx=0.45, panw=2.0),
        "0,5,129": Pan(start_note=(0, 5, 129), pan2=0, panx=0.5, panw=2.0),
        "0,5,130": Pan(start_note=(0, 5, 130), pan2=0, panx=0.5, panw=2.0),
        "0,6,21": Pan(start_note=(0, 6, 21), pan2=0, panx=0.6, panw=2.0),
        "0,6,22": Pan(start_note=(0, 6, 22), pan2=0, panx=0.6, panw=2.0),
        "0,6,23": Pan(start_note=(0, 6, 23), pan2=0, panx=0.6, panw=2.0),
        # m98
        "0,5,131": Pan(start_note=(0, 5, 131), pan2=0, panx=0.55, panw=2.0),
        "0,5,132": Pan(start_note=(0, 5, 132), pan2=0, panx=0.5, panw=2.0),
        "0,5,133": Pan(start_note=(0, 5, 133), pan2=0, panx=0.45, panw=2.0),
        "0,5,134": Pan(start_note=(0, 5, 134), pan2=0, panx=0.4, panw=2.0),
        "0,5,135": Pan(start_note=(0, 5, 135), pan2=0, panx=0.45, panw=2.0),
        "0,5,136": Pan(start_note=(0, 5, 136), pan2=0, panx=0.55, panw=2.0),
        "0,5,137": Pan(start_note=(0, 5, 137), pan2=0, panx=0.4, panw=2.0),
        "0,5,138": Pan(start_note=(0, 5, 138), pan2=0, panx=0.4, panw=2.0),
        "0,5,139": Pan(start_note=(0, 5, 139), pan2=0, panx=0.4, panw=2.0),
        "0,6,24": Pan(start_note=(0, 6, 24), pan2=0, panx=0.6, panw=2.0),
        "0,6,25": Pan(start_note=(0, 6, 25), pan2=0, panx=0.6, panw=2.0),
        "0,6,26": Pan(start_note=(0, 6, 26), pan2=0, panx=0.6, panw=2.0),
        # m99
        "0,0,229": Pan(start_note=(0, 0, 229), pan2=0, panx=0.4, panw=2.0),
        "0,0,230": Pan(start_note=(0, 0, 230), pan2=0, panx=0.35, panw=2.0),
        "0,0,231": Pan(start_note=(0, 0, 231), pan2=0, panx=0.4, panw=2.0),
        "0,0,232": Pan(start_note=(0, 0, 232), pan2=0, panx=0.45, panw=2.0),
        "0,0,233": Pan(start_note=(0, 0, 233), pan2=0, panx=0.4, panw=2.0),
        # m100
        "0,0,234": Pan(start_note=(0, 0, 234), pan2=0, panx=0.35, panw=2.0),
        "0,0,235": Pan(start_note=(0, 0, 235), pan2=0, panx=0.45, panw=2.0),
        "0,0,236": Pan(start_note=(0, 0, 236), pan2=0, panx=0.4, panw=2.0),
        "0,0,237": Pan(start_note=(0, 0, 237), pan2=0, panx=0.4, panw=2.0),
        "0,0,238": Pan(start_note=(0, 0, 238), pan2=0, panx=0.4, panw=2.0),
        "0,0,239": Pan(start_note=(0, 0, 239), pan2=0, panx=0.4, panw=2.0),
        "0,5,140": Pan(start_note=(0, 5, 140), pan2=0, panx=0.65, panw=2.0),
        # m101
        "0,0,240": Pan(start_note=(0, 0, 240), pan2=0, panx=0.35, panw=2.0),
        "0,0,241": Pan(start_note=(0, 0, 241), pan2=0, panx=0.35, panw=2.0),
        "0,0,242": Pan(start_note=(0, 0, 242), pan2=0, panx=0.35, panw=2.0),
        "0,0,243": Pan(start_note=(0, 0, 243), pan2=0, panx=0.35, panw=2.0),
        "0,0,244": Pan(start_note=(0, 0, 244), pan2=0, panx=0.35, panw=2.0),
        "0,1,22": Pan(start_note=(0, 1, 22), pan2=0, panx=0.5, panw=2.0),
        "0,1,23": Pan(start_note=(0, 1, 23), pan2=0, panx=0.5, panw=2.0),
        "0,5,141": Pan(start_note=(0, 5, 141), pan2=0, panx=0.65, panw=2.0),
        # m102
        "0,0,245": Pan(start_note=(0, 0, 245), pan2=0, panx=0.4, panw=2.0),
        "0,0,246": Pan(start_note=(0, 0, 246), pan2=0, panx=0.4, panw=2.0),
        "0,0,247": Pan(start_note=(0, 0, 247), pan2=0, panx=0.4, panw=2.0),
        "0,0,248": Pan(start_note=(0, 0, 248), pan2=0, panx=0.4, panw=2.0),
        "0,5,142": Pan(start_note=(0, 5, 142), pan2=0, panx=0.6, panw=2.0),
        "0,5,143": Pan(start_note=(0, 5, 143), pan2=0, panx=0.6, panw=2.0),
    }
    pan2 = {
