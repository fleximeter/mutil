...
def build_score():
    ...
    pan1 = {
        ...
        # m29
        "0,0,36": Pan(start_note=(0, 0, 36), pan2=0.5, panx=2.5, panw=2.0),
        "0,0,37": Pan(start_note=(0, 0, 37), pan2=0.5, panx=2.5, panw=2.0),
        "0,5,14": Pan(start_note=(0, 5, 14), pan2=0.7, panx=2.3, panw=2.0),
        "0,5,15": Pan(start_note=(0, 5, 15), pan2=0.7, panx=2.3, panw=2.0),
        "0,5,16": Pan(start_note=(0, 5, 16), pan2=0.7, panx=2.3, panw=2.0),
        # m30
        ...
        # m37
        "0,0,67": Pan(start_note=(0, 0, 67), pan2=0.55, panx=0.55, panw=2.0),
        "0,0,68": Pan(start_note=(0, 0, 68), pan2=0.55, panx=0.55, panw=2.0),
        "0,0,69": Pan(start_note=(0, 0, 69), pan2=0.65, panx=2.35, panw=2.0),
        "0,0,70": Pan(start_note=(0, 0, 70), pan2=0.65, panx=2.35, panw=2.0),
        # m38
        ...
        "0,5,149": Pan(start_note=(0, 5, 149), pan2=0.4, panx=0.4, panw=2.0),
        "0,5,150": Pan(start_note=(0, 5, 150), pan2=0.45, panx=0.45, panw=2.0),
        "0,5,151": Pan(start_note=(0, 5, 151), pan2=0.5, panx=0.5, panw=2.0),
        ...
        # m107
        "0,5,165": Pan(start_note=(0, 5, 165), pan2=0.5, panx=0.5, panw=2.0),
        "0,5,166": Pan(start_note=(0, 5, 166), pan2=0.65, panx=0.65, panw=2.0),
        ...
        # m110
        "0,5,180": Pan(start_note=(0, 5, 180), pan2=0.45, panx=0.45, panw=2.0),
        "0,5,181": Pan(start_note=(0, 5, 181), pan2=0.5, panx=0.5, panw=2.0),
        "0,5,182": Pan(start_note=(0, 5, 182), pan2=0.5, panx=0.5, panw=2.0),
        "0,5,183": Pan(start_note=(0, 5, 183), pan2=0.45, panx=0.45, panw=2.0),
        ...
        "0,5,192": Pan(start_note=(0, 5, 192), pan2=0.4, panx=0.4, panw=2.0),
        ...
        "0,5,206": Pan(start_note=(0, 5, 206), pan2=0.45, panx=0.45, panw=2.0),
        "0,5,207": Pan(start_note=(0, 5, 207), pan2=0.5, panx=0.5, panw=2.0),
        # m119
        ...
        "0,5,212": Pan(start_note=(0, 5, 212), pan2=0.55, panx=0.55, panw=2.0),
        ...
        # m134
        "0,5,257": Pan(start_note=(0, 5, 257), pan2=0.55, panx=0.55, panw=2.0),
        "0,5,258": Pan(start_note=(0, 5, 258), pan2=0.6, panx=0.6, panw=2.0),
        "0,5,259": Pan(start_note=(0, 5, 259), pan2=0.6, panx=0.6, panw=2.0),
        ...
        "0,5,263": Pan(start_note=(0, 5, 263), pan2=0.6, panx=0.6, panw=2.0),
        # m135
        "0,5,264": Pan(start_note=(0, 5, 264), pan2=0.55, panx=0.55, panw=2.0),
