...
def build_score():
    ...
    synth_updates1 = [
        ...
        [[0, 3, 5], 10, [0.2, 0.5], [1], [0]],
        [[0, 0, 90], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 34], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 35], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 37], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 40], 10, [0.2, 0.5], [1], [0]],
        ...
        [[0, 5, 77], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 78], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 84], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 87], 10, [0.2, 0.5], [1], [0]],

        # m76-78
        [[0, 5, 88], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 92], 10, [0.2, 0.5], [1], [0]],
        ...
        [[0, 5, 99], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 100], 10, [0.2, 0.5], [1], [0]],
        [[0, 6, 2], 10, [0.2, 0.5], [1], [0]],
        [[0, 6, 3], 10, [0.2, 0.5], [1], [0]],

        # m100-103
        [[0, 0, 244], 10, [0.2, 0.5], [1], [0]],
        [[0, 1, 23], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 140], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 142], 10, [0.2, 0.5], [1], [0]],

        # m116-118
        [[0, 0, 275], 10, [0.2, 0.5], [1], [0]],
        [[0, 0, 278], 10, [0.2, 0.5], [1], [0]],
        [[0, 0, 279], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 200], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 207], 10, [0.2, 0.5], [1], [0]],

        # m127-129
        [[0, 5, 230], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 231], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 232], 10, [0.2, 0.5], [1], [0]],

        # m137
        [[0, 5, 266], 10, [0.2, 0.5], [1], [0]],
    ]

    synth_updates2 = [
        # m5-7
        [[0, 1, 0], 10, [0.2, 0.5], [1], [0]],
        [[0, 1, 1], 10, [0.2, 0.5], [1], [0]],
        [[0, 1, 3], 10, [0.2, 0.5], [1], [0]],
        [[0, 7, 0], 10, [0.2, 0.5], [1], [0]],
        [[0, 7, 1], 10, [0.2, 0.5], [1], [0]],

        # m10-11
        [[0, 1, 9], 10, [0.2, 0.5], [1], [0]],
        [[0, 1, 10], 10, [0.2, 0.5], [1], [0]],
        [[0, 2, 0], 10, [0.2, 0.5], [1], [0]],
        [[0, 7, 2], 10, [0.2, 0.5], [1], [0]],
        [[0, 7, 3], 10, [0.2, 0.5], [1], [0]],

        # m14
        [[0, 1, 14], 10, [0.2, 0.5], [1], [0]],
        [[0, 7, 8], 10, [0.2, 0.5], [1], [0]],

        # m23
        [[0, 1, 24], 10, [0.2, 0.5], [1], [0]],
        [[0, 2, 6], 10, [0.2, 0.5], [1], [0]],
        [[0, 3, 4], 10, [0.2, 0.5], [1], [0]],
        [[0, 4, 3], 10, [0.2, 0.5], [1], [0]],
        [[0, 5, 2], 10, [0.2, 0.5], [1], [0]],
